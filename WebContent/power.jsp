...
<html>
<head>
     <link rel="icon" type="image/ico" href="http://114.215.147.135/phpcms/install_package/www.ico.la_ca1e7985eb20ea16e19679bce1a824df_32X32.ico">
    <link rel="stylesheet" type="text/css" href="http://www.htdtv.cn/statics/css/hs/protocol.css"/>
...
<script type="text/javascript" src="js/bootstrap.min.js"></script>
  ...
  <body id="protocol">
    ...
    <div class="protocol_body" style="font-family: '宋体', Simsun;" mce_style="font-family: '宋体', Simsun;">
      ...
      <p>　　尊敬的客户您好，欢迎您访问北京航数宽网科技有限责任公司网站（以下简称：网站）。在您注册成为网站会员之前，请您务必认真阅读和理解《网站用户注册协议》（以下简称：协议）中所有的条款。您须完全同意协议中所有的条款，才可以注册成为本网站的会员，使用里面的服务。您在网站的注册和操作均将被视为是您对协议所有条款及内容的自愿接受。<br />
<strong>　　第一条</strong> <strong>声明</strong><br />
　　（一）网站内在线产品的所有权归北京航数宽网科技有限责任公司所有。<br />
